        ...
        <div class="flex-body justifyStart">
            ...
            <div class="card">
                <a class="box" href="">
                    ...
                    <div class="btn card-header">View Client Information</div>
                </a>
            </div>

            <div class="card">
                <a class="box" href="../HeadOffice/manage_regional_offices">
                    <div class="card-image">
                    ...
                    <div class="btn card-header">Manage Regional Offices</div>
                </a>
            </div>
        ...
        <div class="flex-body justifyStart"> -->
            <div class="card">
                <a class="box" href="">
                    ...
                    <div class="btn card-header">View Statistics</div>
                </a>
            </div>
            ...
            <div class="card">
                <a class="box" href="">
                    ...
                    <div class="btn card-header">Manage Budget</div>
                </a>
            </div>
